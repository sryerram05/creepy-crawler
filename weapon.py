...
class Weapon():
    ...
    def update(self, player):
        ...
        y_dist = -(pos[1] - self.rect.centery)#-ve because pygame coordinates increase down the screen
...
class Arrow(pygame.sprite.Sprite):
    def __init__(self, image, x, y, angle):
        ...
        self.dy = -(math.sin(math.radians(self.angle)) * constants.ARROW_SPEED)#-ve becuase pygame y coordinate increases down the screen
...
class Fireball(pygame.sprite.Sprite):
    def __init__(self, image, x, y, target_x, target_y):
        ...
        self.dy = -(math.sin(math.radians(self.angle)) * constants.FIREBALL_SPEED)#-ve becuase pygame y coordinate increases down the screen
